...
def telemetry(sid, data):
    if data:
        ...
        resized = (cv2.resize((cv2.cvtColor(transformed_image_array[0], 
        	                   cv2.COLOR_RGB2HSV))[:,:,1],(320,160))).reshape(1,160,320,1)
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        'model',
        type=str,
        help='Path to model json file. Model weights should be on the same path.'
    )
    parser.add_argument(
        'image_folder',
        type=str,
    ...
    with open(args.model, 'r') as f:
        ...
        model_version = json_data["keras_version"]
