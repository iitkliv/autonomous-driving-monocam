# How to run in my laptop

Change sequence numbers on line 427 according to number of results you have.

Add gt_poses to data/odometry/poses/  as %02.txt
Add output_poses to data/result_nn/data/ as %02.txt

Run the script as:
./evaluate_odometry data/result_nn
